...
This agent handles code execution for generation and review operations.
It is used as a sub-agent by Generation and Reviewer agents to execute code
when needed (e.g., verifying mathematical solutions, running test code).
"""
