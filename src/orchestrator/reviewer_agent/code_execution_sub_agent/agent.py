"""
Code Execution Sub-Agent for Reviewer Agent

This sub-agent handles code execution for review operations.
It is used by the Reviewer Agent to execute code when needed
(e.g., validating technical correctness, running test code).
"""
